const Portfolio = () => {
  const artists = [
    {
      name: "Dudstattoo",
      instagram: "dudstattoo",
    },
    {
      name: "Calderano Tattoo",
      instagram: "calderanotattoo",
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-muted-foreground font-body text-sm sm:text-base md:text-lg max-w-2xl mx-auto">
            Acompanhe o trabalho dos nossos artistas e inspire-se com as últimas criações
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {artists.map((artist) => (
            <div key={artist.instagram} className="flex flex-col">
